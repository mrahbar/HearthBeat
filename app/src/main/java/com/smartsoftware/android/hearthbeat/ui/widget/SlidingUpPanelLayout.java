...
public class SlidingUpPanelLayout extends ViewGroup {
    ...
    private boolean mIsBackgroundFadeEnabled = true;
    ...
    public void setBackgroundFadeEnabled(boolean isBackgroundFadeEnabled) {
        this.mIsBackgroundFadeEnabled = isBackgroundFadeEnabled;
    }
